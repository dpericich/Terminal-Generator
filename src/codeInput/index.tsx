...
const CodeInputElement = <codeInput, setCodeInput>(props: codeInputElementProps): ReactElement => {
    return(
        <div>
            ...
            <textarea name="" id="" cols={90} rows={20} value={props.codeInput} onChange={(e) => {props.setCodeInput(e.target.value)}}></textarea>
            <div className="button">Generate Code</div>
        </div>
    )
};
